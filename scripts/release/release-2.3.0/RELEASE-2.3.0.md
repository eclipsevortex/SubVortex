This guide provides step-by-step instructions for the release 2.3.0.

Previous Release: 2.2.9
...
4. **Remove useless packages**: Remove `transformers` package which is not used anymore
   ```bash
