class Miner:
    ...
    def __init__(
        ...
        self.penalise_factor = penalise_factor
    ...
    def __eq__(self, other):
        if isinstance(other, Miner):
            return (
                ...
                and self.penalise_factor == other.penalise_factor
            )
        return False
