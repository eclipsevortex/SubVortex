...
class ChallengeModel:
    ...
    def _key(self, instance: int, id: str) -> str:
        return f"sv:challenge:{instance}:{id}"

    async def read(self, redis: Redis, id: str) -> Challenge | None:
        key = self._key(id)
    ...
    async def write(self, redis: Redis, challenge: Challenge):
        key = self._key(challenge.id)
    ...
    async def delete(self, redis: Redis, id: str):
        key = self._key(id)
