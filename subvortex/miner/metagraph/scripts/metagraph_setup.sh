...
setup_process() {
    ...
    $SERVICE_WORKING_DIR/deployment/process/metagraph_process_setup.sh
...
setup_container() {
    ...
    $SERVICE_WORKING_DIR/deployment/docker/metagraph_docker_setup.sh
...
setup_service() {
    ...
    $SERVICE_WORKING_DIR/deployment/service/metagraph_service_setup.sh
