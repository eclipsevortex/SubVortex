...
setup_process() {
    ...
    $SERVICE_WORKING_DIR/deployment/process/metagraph_process_stop.sh
...
setup_container() {
    ...
    $SERVICE_WORKING_DIR/deployment/docker/metagraph_docker_stop.sh
...
setup_service() {
    ...
    $SERVICE_WORKING_DIR/deployment/service/metagraph_service_stop.sh
