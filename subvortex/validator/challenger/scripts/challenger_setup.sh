...
setup_process() {
    ...
    $SERVICE_WORKING_DIR/deployment/process/challenger_process_setup.sh
...
setup_container() {
    ...
    $SERVICE_WORKING_DIR/deployment/docker/challenger_docker_setup.sh
...
setup_service() {
    ...
    $SERVICE_WORKING_DIR/deployment/service/challenger_service_setup.sh
