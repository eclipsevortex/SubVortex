...
setup_process() {
    ...
    $SERVICE_WORKING_DIR/deployment/process/challenger_process_start.sh
...
setup_container() {
    ...
    $SERVICE_WORKING_DIR/deployment/docker/challenger_docker_start.sh
...
setup_service() {
    ...
    $SERVICE_WORKING_DIR/deployment/service/challenger_service_start.sh
