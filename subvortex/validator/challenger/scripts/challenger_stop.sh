...
setup_process() {
    ...
    $SERVICE_WORKING_DIR/deployment/process/challenger_process_stop.sh
...
setup_container() {
    ...
    $SERVICE_WORKING_DIR/deployment/docker/challenger_docker_stop.sh
...
setup_service() {
    ...
    $SERVICE_WORKING_DIR/deployment/service/challenger_service_stop.sh
