...
SERVICE_NAME=subvortex-validator-challenger
...
SERVICE_WORKING_DIR="$PROJECT_WORKING_DIR/subvortex/validator/challenger"
...
setup_process() {
    ...
    $SERVICE_WORKING_DIR/deployment/process/challenger_process_teardown.sh
...
setup_container() {
    ...
    $SERVICE_WORKING_DIR/deployment/docker/challenger_docker_teardown.sh
...
setup_service() {
    ...
    $SERVICE_WORKING_DIR/deployment/service/challenger_service_teardown.sh
