...
266|subvor | 2025-06-05 04:20:30.530 |      DEBUG       | Settings: Settings(logging_name='Metagraph', key_prefix='sv', netuid=92, sync_interval=100, dry_run=False, database_host='localhost', database_port=6379, database_index=0, database_password='')
...
```bash
● subvortex-validator-metagraph.service - SubVortex Validator Metagraph
     Loaded: loaded (/etc/systemd/system/subvortex-validator-metagraph.service; disabled; vendor preset: enabled)
     Active: active (running) since Thu 2025-06-05 04:23:57 CEST; 2min 16s ago
   Main PID: 3673235 (python3)
      Tasks: 9 (limit: 19116)
     Memory: 141.5M
        CPU: 31.941s
     CGroup: /system.slice/subvortex-validator-metagraph.service
             └─3673235 /root/SubVortex/subvortex/validator/metagraph/venv/bin/python3 -m subvortex.validator.metagraph.src.main

Jun 05 04:23:57 vmi1561561.contaboserver.net systemd[1]: Started SubVortex Validator Metagraph.
```

And check the log by running

```
tail -f /var/log/subvortex-validator/subvortex-validator-metagraph.log
```
...
2025-06-05 04:24:00.863 |      DEBUG       | Settings: Settings(logging_name='Metagraph', key_prefix='sv', netuid=92, sync_interval=100, dry_run=False, database_host='localhost', database_port=6379, database_index=0, database_password='')
...
2025-06-05 02:29:25.688 |      DEBUG       | Settings: Settings(logging_name='Metagraph', key_prefix='sv', netuid=92, sync_interval=100, dry_run=False, database_host='localhost', database_port=6379, database_index=0, database_password='')
...
```bash
./subvortex/validator/metagraph/scripts/metagraph_querier.sh --namespace=neuron [options]
```
...
```bash
./subvortex/validator/metagraph/scripts/metagraph_querier.sh --namespace=neuron
```
...
```bash
./subvortex/validator/metagraph/scripts/metagraph_querier.sh --namespace=neuron --fields=uid,stake,hotkey
```
...
```bash
./subvortex/validator/metagraph/scripts/metagraph_querier.sh  --namespace=neuron --sort=-uid
```
...
```bash
./subvortex/validator/metagraph/scripts/metagraph_querier.sh \
  --namespace=neuron \
  --filter uid=60
```
