...
export $(grep -v '^#' ./subvortex/validator/neuron/.env | xargs)
...
setup_process() {
    ...
    ./subvortex/validator/neuron/deployment/process/neuron_process_stop.sh
...
setup_container() {
    ...
    ./subvortex/validator/neuron/deployment/docker/neuron_docker_stop.sh
...
setup_service() {
    ...
    ./subvortex/validator/neuron/deployment/service/neuron_service_stop.sh
