...
show_help() {
    ...
    echo
    echo "Description:"
    echo "  This script stop the validator neuron"
    echo
    echo "Options:"
...
setup_process() {
    ...
    ./deployment/process/neuron_process_stop.sh
...
setup_container() {
    ...
    ./deployment/docker/neuron_docker_stop.sh
...
setup_service() {
    ...
    ./deployment/service/neuron_service_stop.sh
