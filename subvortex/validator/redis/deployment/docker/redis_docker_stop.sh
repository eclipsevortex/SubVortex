...
# Stop the validator-redis container
echo "🛑 Stopping Validator Redis container..."
$DOCKER_CMD -f "$COMPOSE_FILE" stop validator-redis

echo "✅ Validator Redis container stopped successfully."
