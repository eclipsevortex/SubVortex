...
# Tear down the validator-redis container
echo "🧹 Tearing down Validator Redis container and removing images..."
$DOCKER_CMD -f "$COMPOSE_FILE" down validator-redis --rmi all

echo "✅ Validator Redis Docker teardown completed successfully."
