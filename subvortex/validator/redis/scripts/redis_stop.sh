...
setup_process() {
    ...
    ./subvortex/validator/redis/deployment/process/redis_process_stop.sh
...
setup_container() {
    ...
    ./subvortex/validator/redis/deployment/docker/redis_docker_stop.sh
...
setup_service() {
    ...
    ./subvortex/validator/redis/deployment/service/redis_service_stop.sh
