...
setup_process() {
    ...
    $SERVICE_WORKING_DIR/deployment/process/redis_process_stop.sh
...
setup_container() {
    ...
    $SERVICE_WORKING_DIR/deployment/docker/redis_docker_stop.sh
...
setup_service() {
    ...
    $SERVICE_WORKING_DIR/deployment/service/redis_service_stop.sh
