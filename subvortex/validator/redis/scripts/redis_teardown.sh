...
show_help() {
    ...
    echo
    echo "Description:"
    echo "  This script teardown the validator redis"
    echo
    echo "Options:"
...
setup_process() {
    ...
    ./deployment/process/redis_process_teardown.sh
...
setup_container() {
    ...
    ./deployment/docker/redis_docker_teardown.sh
...
setup_service() {
    ...
    ./deployment/service/redis_service_teardown.sh
